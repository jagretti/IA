...
def polygon(coords, outlineColor, fillColor = None, filled = 1,
    ...
    poly = _canvas.create_polygon(c, outline = outlineColor,
                                  fill = fillColor, smooth = smoothed,
                                  width = width)
    if behind > 0:
...
def circle(pos, r, outlineColor, fillColor, endpoints = None,
           style = 'pieslice', width = 2):
    x, y = pos
    x0, x1 = x - r - 1, x + r
    y0, y1 = y - r - 1, y + r
    if endpoints == None:
    ...
    return _canvas.create_arc(x0, y0, x1, y1, outline = outlineColor,
                              fill = fillColor, extent = e[1] - e[0],
                              start = e[0], style = style, width = width)

def image(pos, file = '../../blueghost.gif'):
    x, y = pos
    # img = PhotoImage(file=file)
    return _canvas.create_image(x, y,
