...
def readCommand(argv):
    '''Process the command line used to run pacman.'''
    ...
    parser.add_option('-t', '--textGraphics',
                      action = 'store_true',
                      dest = 'textGraphics',
    ...
    parser.add_option('-q', '--quietTextGraphics',
                      ...
                      default = False)
    parser.add_option('-g', '--ghosts',
                      dest = 'ghost',
                      help = default('the ghost agent TYPE in the ghostAgents module to use'),
                      metavar = 'TYPE',
                      default = 'RandomGhost')
    parser.add_option('-k', '--numghosts',
                      type = 'int',
                      dest = 'numGhosts',
    ...
    parser.add_option('-z', '--zoom',
                      ...
                      default = 1.0)
    parser.add_option('-f', '--fixRandomSeed',
                      action = 'store_true',
                      dest = 'fixRandomSeed',
                      help = 'Fixes the random seed to always play the same game',
                      default = False)
    parser.add_option('-r', '--recordActions',
                      action = 'store_true',
                      dest = 'record',
    ...
    parser.add_option('--replay',
                      ...
                      default = None)
    parser.add_option('-a','--agentArgs',
                      dest = 'agentArgs',
                      help = 'Comma separated values sent to agent. e.g. "opt1=val1,opt2,opt3=val3"')
    parser.add_option('-x', '--numTraining',
                      dest = 'numTraining',
                      type = 'int',
    ...
    parser.add_option('--frameTime',
                      ...
                      default = 0.1)
    parser.add_option('-c', '--catchExceptions',
                      action = 'store_true',
...
def loadAgent(pacman, nographics):
    # Look through all pythonPath Directories for the right module.
